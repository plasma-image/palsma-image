...
if real_data :
    if average:
        data1=np.load('jz_t40.0_nx1024_ny1024.npz')
        data4=np.load('jz_t50.0_nx1024_ny1024.npz')
        data2=np.load('jz_t60.0_nx1024_ny1024.npz')
        data3=np.load('jz_t40.0_nx2048_ny2048.npz')
        data5=np.load('jz_t50.0_nx2048_ny2048.npz')
        data6= np.load('jz_t50point0.npz')
        data7= np.load('jz_t46point0.npz')
        data8= np.load('jz_t54point0.npz')
        data9=np.load('jz_t60.0_nx2048_ny2048.npz')
    ...
    thicknesses_of_cs_x1, thicknesses_of_cs_x2 = generate_cs_in_turbulence()
...
number_of_points_upto_local_boundary = 30
...
indexes_of_points_of_all_cs = detect_current_sheets(jz_magnitude, \
...
#    
#plt.plot(np.sort(thicknesses_of_cs_x2),'r+',markersize=10,label='Generated')
#plt.plot(np.sort(ave_thicknesses),'ob',markerfacecolor='none',markersize=10,label='Calculated')
#plt.xlabel('#Number of CS')
#plt.ylabel('Half thickness/$d_{i}$')
#plt.legend()
#plt.show()
#
#index=range(1,11)
#plt.plot(index,np.sort(thicknesses_of_cs_x2),'r+',markersize=10,label='Generated thickness')
#index=range(1,10)
#plt.plot(index,np.sort(ave_thicknesses),'ob',markerfacecolor='none',markersize=10,label='Calculated thickness')
#plt.xlabel('#Number of CS')
#plt.ylabel('Half thickness/$d_{i}$')
#plt.legend()
#plt.show()
...
##############################################################################    
#
#plt.plot(ave_thicknesses,lengths_pairwise,'ob')
#plt.legend(prop={'size': 20}, title = '$J_{thr}=j_{rms} $\n$n=100$ \n$\omega_{ci}t=60$',title_fontsize=20)
#plt.title('Resolution: $2048 x 2048$',fontsize=20)  
#plt.ylabel('Length/$d_i$')
#plt.xlabel('Thickness/$d_i$')
#plt.show()
...
##
#np.savez('./output/'+customized_folder_name+'/characterization_1024_t60_Jthrjrms', 
#         lengths_pairwise=length_gt_0point25, 
#         ave_thicknesses=thickness_gt_0point25,
#         aspect_ratios=aspect_ratios)
#
#
#np.savez('./output/'+customized_folder_name+'/lengths_pairwise_2048_t60_Jthrjrms_n100', 
#         lengths_pairwise=length_gt_0point25)
#
#
#np.savez('./output/'+customized_folder_name+'/ave_thicknesses_2048_t60_Jthrjrms_n100', 
#         ave_thicknesses=thickness_gt_0point25
#)
#
#
#np.savez('./output/'+customized_folder_name+'/aspect_ratios_2048_t60_Jthrjrms_n100', 
#         aspect_ratios=aspect_ratios)
#
#np.savez('./output/'+customized_folder_name+'/peakvalues_2048_t60_Jthrjrms_n100', 
#         peakvalues=value_of_pjz_peak)
#
#
...
##############################################################################
##
#np.savez('./output/'+customized_folder_name+'/characterization_512_t54_Jthrjrms', 
#         lengths_pairwise=length_gt_0point25, 
#         ave_thicknesses=thickness_gt_0point25,
#         aspect_ratios=aspect_ratios)
#
#
#np.savez('./output/'+customized_folder_name+'/lengths_pairwise_512_t54_Jthrueuiz_n30', 
#         lengths_pairwise=length_gt_0point25)
#
#
#np.savez('./output/'+customized_folder_name+'/ave_thicknesses_512_t54_Jthrueuiz_n30', 
#         ave_thicknesses=thickness_gt_0point25
#)
#
#
#np.savez('./output/'+customized_folder_name+'/aspect_ratios_512_t54_Jthrueuiz_n30', 
#         aspect_ratios=aspect_ratios)
#
#np.savez('./output/'+customized_folder_name+'/peakvalues_512_t54_Jthrueuiz_n30', 
#         peakvalues=value_of_pjz_peak)
#
#
#df = pd.DataFrame(data={'t':[t_of_input_file],'resolution':[resolution]})
