...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 23 14:51:37 2020
...
#############################################################
#def find_thickness(coord_1d,data_1d,data_value):
    # This function finds the distance along x-coordinate from the first 
    # data point to the point where data_1d < data_value for the first time.
    # Input:
    # coord_1d: 1-d array of coordinates
    # data_1d : 1-d array of data values at the coord_1d.
    # data_value: (scalar) a particular value of the data  
    # output:
    # thickness: (scalar) distance from the first 
    # data point to the point where data_1d < data_value for the first time
#   for index,value in enumerate(data_1d):
#        if (value < data_value):
#            thickness=coord_1d[index]
#            break
...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  7 20:50:29 2020

"""
def characterize_cs(jz_magnitude,xx,yy,j_min):
